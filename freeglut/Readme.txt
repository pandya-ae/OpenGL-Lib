...
2011–12–12: Release 2.6.0-4.mp

  • Rebuilt the package to include the 64 bit DLL and import library.
  • Updated the documentation to include details of building 64 bit
    applications.
